        ...
        <div class="row align-items-center g-4">
          <div class="col-lg-7">
            ...
            <div class="d-flex flex-wrap gap-3 mt-3">
              <span class="btn btn-light btn-lg rounded-pill px-5 py-3 fw-bold text-dark email-modal">
                <i class="fas fa-calendar-check me-2"></i> Book a call
              </span>
              <span class="btn btn-outline-light btn-lg rounded-pill px-5 py-3" style="display: none;">
