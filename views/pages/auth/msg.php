...
<body>
  ...
  <div class="main-wrapper" id="mainWrapper">
    ...
    <div class="page-content">
      ...
      <!-- page header -->
      <div class="d-flex flex-wrap align-items-center justify-content-between mb-4 page-heading">
        <div>
      ...
      <div class="chat-container bg-white rounded-4 border border-light overflow-hidden">
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4 border-end">
            ...
            <!-- chat list -->
            <div class="chat-list" style="max-height: 600px; overflow-y: auto; display:none;">
          ...
          <div class="col-lg-9 col-md-8 d-flex flex-column" style="height: 650px;">
            ...
            <!-- chat messages -->
            <div id="chatContainer" class="flex-grow-1 p-3 overflow-auto" style="background: #f8f9fa;">
